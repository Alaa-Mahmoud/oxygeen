 ...
 * @author pc
 */
public class LOgisticsteam extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Logistics_data", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       // int max = db.getMax("hr_id", "hr");        
        String sql = "insert into logistics(name,mobile,home_num,email,collage,birthdate,image) values(?,?,?,?,?,?,?)";
        ...
        try {
         ...
         con = Connect.connect();
        String sql2 = " select log_id as `ID`, name as `name` , mobile as `Mobile` , home_num as `Home number` ,email as `E-mail` , collage as `Work Domain`,birthdate as `Age` from logistics"; 
        try {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
      con = Connect.connect();
        ...
        int row = jTable1.getSelectedRow();
        String values = jTable1.getModel().getValueAt(row, 0).toString();
        String sql = "update logistics set name ='" + txtname.getText() + "',mobile ='" + txtmob.getText() + "',home_num='" + txthome.getText() + "',email='" + txtemail.getText() + "',collage='" + txtkol.getText() + "',birthdate='" + jDateChooser1.getText()+ "' where log_id=?";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      int row = jTable1.getSelectedRow();
        ...
        String sql = "select * from logistics where log_id ='" + value + "'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         con = Connect.connect();
        String sql = "Select log_id,name from logistics where name ='" + jTextField7.getText() + "'";
        try {
            pst = con.prepareStatement(sql);
            res = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(res));
...
//            String report="J:\\All Project\\report\\pharmcy_login_report.jrxml";
                        ...
                        String sql2 = " select name as `name` , mobile as `Mobile` , home_num as `Home number` , "
                                + "email as `E-mail` , collage as `Work Domain`,birthdate as `Age` from logistics where name like '" + jTextField7.getText() + "%' ";
...
//                                
                                ...
                                String sql1 = "select * from logistics where name is null";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LOgisticsteam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LOgisticsteam().setVisible(true);
            }
        });
    }
  ...
  public Image resized(Image img, int w, int h) {
     ...
     public void resetdata() {
        ...
        jDateChooser1.setText(null);
          ...
          con = Connect.connect();
        String sql = " select log_id as `ID`, name as `name` , mobile as `Mobile` , home_num as `Home number` ,email as `E-mail` , collage as `Work Domain`,birthdate as `Age` from logistics"; 
        try {
            pst = con.prepareStatement(sql);
            res = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(res));
      ...
      public void elements() {
        con = Connect.connect();
        String sql = "select log_id as\"ID\",name as\"Name\" from logistics";
        try {
            pst = con.prepareStatement(sql);
            res = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(res));
