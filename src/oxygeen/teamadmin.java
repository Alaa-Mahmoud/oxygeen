 ...
 * @author pc
 */
public class teamadmin extends javax.swing.JFrame {

    /**
     * Creates new form teamadmin
     */
    Connection con = null;
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Team Admins_data", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jLabel8.setText("نوع المسؤليه");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "president", "vicar1", "vicar2" }));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtkol, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(txtmob, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(45, 45, 45)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        con = Connect.connect();
        String sql = "Select ad_id,name from administrators where name ='" + jTextField7.getText() + "'";
        try {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String sql = "update administrators set name ='" + txtname.getText() + "',mobile ='" + txtmob.getText() + "',home_num='" + txthome.getText() + "',email='" + txtemail.getText() + "',collage='" + txtkol.getText() + "',birthdate='" + jDateChooser1.getText() + "', type='" + jComboBox1.getSelectedItem() + "' where ad_id=?";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int row = jTable1.getSelectedRow();
        String values = jTable1.getModel().getValueAt(row, 0).toString();
        String sql = "delete from administrators where ad_id=? ";
        try {
            pst = con.prepareStatement(sql);
            pst.setString(1, values);
            pst.executeUpdate();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       // Connect db = new Connect();
        ...
        String sql = "insert into administrators(name,mobile,home_num,email,collage,birthdate,type,image) values(?,?,?,?,?,?,?,?)";
        ...
        String sql2 = " select ad_id as `ID`, name as `name` , mobile as `Mobile` , home_num as `Home number` , "
                + "email as `E-mail` , collage as `Work Domain`,birthdate as `Age`,type as `Admin Type` from administrators";
        try {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String sql = "select * from administrators where ad_id ='" + value + "'";
...
//            String report="J:\\All Project\\report\\pharmcy_login_report.jrxml";
                        ...
                        String sql2 = " select name as `name` , mobile as `Mobile` , home_num as `Home number` , "
                                + "email as `E-mail` , collage as `Work Domain`,birthdate as `Age`,type as `Admin Type` from administrators where name like '" + jTextField7.getText() + "%' ";
...
//                                
                                ...
                                String sql1 = "select * from administrators where name is null";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teamadmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void elements() {
        con = Connect.connect();
        String sql = "select ad_id as\"ID\",name as\"Name\" from administrators";
        try {
            pst = con.prepareStatement(sql);
            res = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(res));
