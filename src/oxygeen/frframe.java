...
public class frframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "FR&markting _data", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       // int max = db.getMax("hr_id", "hr");        
        String sql = "insert into frmarkting(name,mobile,home_num,email,collage,birthdate,image) values(?,?,?,?,?,?,?)";
        ...
        try {
         ...
         con = Connect.connect();
        String sql2 = " select fr_id as `ID`, name as `name` , mobile as `Mobile` , home_num as `Home number` ,email as `E-mail` , collage as `Work Domain`,birthdate as `Age` from logistics"; 
        try {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        String sql = "delete from frmarkting where fr_id=? ";
        try {
            pst = con.prepareStatement(sql);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        int row = jTable1.getSelectedRow();
        String values = jTable1.getModel().getValueAt(row, 0).toString();
        String sql = "update frmarkting set name ='" + txtname.getText() + "',mobile ='" + txtmob.getText() + "',home_num='" + txthome.getText() + "',email='" + txtemail.getText() + "',collage='" + txtkol.getText() + "',birthdate='" + jDateChooser1.getText()+ "' where fr_id=?";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        con = Connect.connect();
        String sql = "Select fr_id,name from frmarkting where name ='" + jTextField7.getText() + "'";
        try {
            pst = con.prepareStatement(sql);
            res = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(res));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String sql = "select * from frmarkting where fr_id ='" + value + "'";
...
//            String report="J:\\All Project\\report\\pharmcy_login_report.jrxml";
                        ...
                        String sql2 = " select name as `name` , mobile as `Mobile` , home_num as `Home number` , "
                                + "email as `E-mail` , collage as `Work Domain`,birthdate as `Age` from frmarkting where name like '" + jTextField7.getText() + "%' ";
...
//                                
                                ...
                                String sql1 = "select * from frmarkting where name is null";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
  ...
  public Image resized(Image img, int w, int h) {
     ...
     public void resetdata() {
        ...
        jDateChooser1.setText(null);
         ...
         con = Connect.connect();
        String sql = " select fr_id as `ID`, name as `name` , mobile as `Mobile` , home_num as `Home number` ,email as `E-mail` , collage as `Work Domain`,birthdate as `Age` from frmarkting"; 
        try {
            pst = con.prepareStatement(sql);
            res = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(res));
      ...
      public void elements() {
        con = Connect.connect();
        String sql = "select fr_id as\"ID\",name as\"Name\" from frmarkting";
        try {
            pst = con.prepareStatement(sql);
            res = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(res));
