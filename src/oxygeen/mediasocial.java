 ...
 * @author pc
 */
public class mediasocial extends javax.swing.JFrame {

    /**
     * Creates new form mediasocial
     */
     Connection con = null;
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Media&socialmedia_data", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jLabel8.setText("الوظيفه");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Photographer", "Designer", "Socialmedia" }));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       // int max = db.getMax("hr_id", "hr");        
        String sql = "insert into mediasocial(name,mobile,home_num,email,collage,birthdate,type,image) values(?,?,?,?,?,?,?,?)";
        ...
        String sql2 = " select id as `ID`, name as `name` , mobile as `Mobile` , home_num as `Home number` , "
                                + "email as `E-mail` , collage as `Work Domain`,birthdate as `Age`,type as `Type` from mediasocial";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        String sql = "delete from mediasocial where id=? ";
        try {
            pst = con.prepareStatement(sql);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        int row = jTable1.getSelectedRow();
        String values = jTable1.getModel().getValueAt(row, 0).toString();
        String sql = "update mediasocial set name ='" + txtname.getText() + "',mobile ='" + txtmob.getText() + "',home_num='" + txthome.getText() + "',email='" + txtemail.getText() + "',collage='" + txtkol.getText() + "',birthdate='" + jDateChooser1.getText()+ "',type='"+jComboBox1.getSelectedItem()+"' where id=?";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        con = Connect.connect();
        String sql = "Select id,name from mediasocial where name ='" + jTextField7.getText() + "'";
        try {
            pst = con.prepareStatement(sql);
            res = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(res));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       int row = jTable1.getSelectedRow();
        ...
        String sql = "select * from mediasocial where id ='" + value + "'";
...
//            String report="J:\\All Project\\report\\pharmcy_login_report.jrxml";
                        ...
                        String sql2 = " select name as `name` , mobile as `Mobile` , home_num as `Home number` , "
                                + "email as `E-mail` , collage as `Work Domain`,birthdate as `Age`,type as `Type` from mediasocial where name like '" + jTextField7.getText() + "%' ";
...
//                                
                                ...
                                String sql1 = "select * from mediasocial where name is null";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mediasocial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mediasocial().setVisible(true);
            }
        });
    }
  ...
  public Image resized(Image img, int w, int h) {
     ...
     public void resetdata() {
      ...
      public void elements() {
        con = Connect.connect();
        String sql = "select id as\"ID\",name as\"Name\" from mediasocial";
        try {
            pst = con.prepareStatement(sql);
            res = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(res));
